...
namespace Pathfinding {
	 ...
	 * 1. Rasterize Meshes is slow. If you are using a tiled graph and you are updaing it, every time something is recalculated
	 ...
	 * 2. The RecastMeshObj exposes some options which can not be accessed using the Rasterize Meshes toggle. See member documentation for more info.
	 * 
	...
	public class RecastMeshObj : MonoBehaviour {
		 ...
		 * If you of some reason want to move it, but don't want it dynamic (maybe you will only move it veery seldom and have lots of similar
